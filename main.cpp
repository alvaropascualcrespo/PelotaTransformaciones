        ...
        if (inicio == true)
          {
                ...
                GLdouble yCentro = -85.5106880612889;
                GLdouble xCentro = -228.028524048727;
                Elipse* e = new Elipse(new PV2D(xCentro,yCentro),200,40,true,20);
                ...
                if (direccion == true){
                        ...
                        GLScene();
                        escena->pelota->ponerVelocidad(20);
                        for(int k=0; k<escena->nObstaculos && k < 8; k++){
                                if ((k%2) == 1){
                                        ((Recubrimiento*)(escena->obstaculos[k]))->velocidad = 20;
                                }
                        }
                        GLScene();
                }
                        ...
                        if (triangulo == true)
                        {
                                ...
                                GLScene();
                                        ...
                                        if(elipses == true){
                                                ...
                                                FormElipse = new TFormElipse(NULL);
                                                FormElipse->ShowModal();
                                                AnsiString al = FormElipse->EditAlto->Text;
                                                ...
                                                escena->aniadirObstaculo(e);
                                               // Elipse* e1 = new Elipse(new PV2D(xCentro,yCentro),alt+escena->pelota->radio,anc+escena->pelota->radio,false,escena->pelota->velocidad);
